...
function calcy(d) {
	...
	if (year == "2022"){ypos = 640;	};
	if (year == "2023"){ypos = 660;	};
	if (year == "2024"){ypos = 680;	};
	if (year == "2025"){ypos = 700;	};
